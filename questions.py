...
def play_audio_stream(audio_stream):
    ...
    # Use Streamlit's audio widget to play the audio
    st.audio(temp_audio_name, format="audio/mp3")
...
# Function to capture real-time audio and save it as a WAV file
def record_audio(file_path, duration=5, sample_rate=16000):
    """
    Record audio from the microphone and save it to a file.
    """
    st.write(f"Recording... Speak for {duration} seconds.")
    try:
        # Record audio
